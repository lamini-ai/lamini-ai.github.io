...
` `<span>`class `<span class="ident">`Lamini`</span></span>` `<span>`(`</span><span>`model_name: str, api_key: Optional[str] = None, api_url: Optional[str] = None, local_cache_file: Optional[str] = None, config: dict = {})`</span>` `
...
` `<span>`async def `<span class="ident">`async_generate`</span></span>`(`<span>`self, prompt: Union[str, List[str]], model_name: Optional[str] = None, output_type: Optional[dict] = None, max_tokens: Optional[int] = None, max_new_tokens: Optional[int] = None, callback: Optional[Callable] = None, metadata: Optional[List] = None)`</span>` `
...
` `<span>`def `<span class="ident">`cancel_all_jobs`</span></span>`(`<span>`self)`</span>` `
...
` `<span>`def `<span class="ident">`cancel_job`</span></span>`(`<span>`self, job_id=None)`</span>` `
...
` `<span>`def `<span class="ident">`check_job_status`</span></span>`(`<span>`self, job_id=None)`</span>` `
...
` `<span>`def `<span class="ident">`evaluate`</span></span>`(`<span>`self, job_id=None)`</span>` `
...
` `<span>`def `<span class="ident">`generate`</span></span>`(`<span>`self, prompt: Union[str, List[str]], model_name: Optional[str] = None, output_type: Optional[dict] = None, max_tokens: Optional[int] = None, max_new_tokens: Optional[int] = None, callback: Optional[Callable] = None, metadata: Optional[List] = None)`</span>` `
...
` `<span>`def `<span class="ident">`get_jobs`</span></span>`(`<span>`self)`</span>` `
...
` `<span>`def `<span class="ident">`make_llm_req_map`</span></span>`(`<span>`self, model_name, prompt, output_type, max_tokens, max_new_tokens)`</span>` `
...
` `<span>`def `<span class="ident">`resume_job`</span></span>`(`<span>`self, job_id=None)`</span>` `
...
` `<span>`def `<span class="ident">`train`</span></span>`(`<span>`self, data_or_dataset_id: Union[str, Iterable[Dict[str, Union[int, float, str, bool, Dict, List]]]], finetune_args: Optional[dict] = None, gpu_config: Optional[dict] = None, enable_peft: Optional[bool] = None, peft_args: Optional[dict] = None, is_public: Optional[bool] = None, use_cached_model: Optional[bool] = None, multi_node: Optional[bool] = None)`</span>` `
...
` `<span>`def `<span class="ident">`train_and_wait`</span></span>`(`<span>`self, data_or_dataset_id: Union[str, Iterable[Dict[str, Union[int, float, str, bool, Dict, List]]]], finetune_args: Optional[dict] = None, gpu_config: Optional[dict] = None, enable_peft: Optional[bool] = None, peft_args: Optional[dict] = None, is_public: Optional[bool] = None, use_cached_model: Optional[bool] = None, multi_node: Optional[bool] = None, **kwargs)`</span>` `
...
` `<span>`def `<span class="ident">`upload_data`</span></span>`(`<span>`self, data: Iterable[Dict[str, Union[int, float, str, bool, Dict, List]]], is_public: Optional[bool] = None)`</span>` `
...
` `<span>`def `<span class="ident">`upload_file`</span></span>`(`<span>`self, file_path: str, input_key: str = 'input', output_key: str = 'output')`</span>` `
